# Generated by Django 2.2.11 on 2020-03-12 19:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animalname', models.CharField(choices=[('Cow', 'Cow'), ('Buffaloe', 'Buffalo'), ('Buffaloe-Cow', 'Buffalo-Cow'), ('Others', 'Others')], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('animalname', models.CharField(choices=[('Cow', 'Cow'), ('buffalo', 'Buffalo'), ('Others', 'Others')], max_length=200)),
                ('milkprice', models.FloatField(db_index=True, max_length=200)),
